...
/// Shared mobile analytics UI — used on the admin home tab and full-screen route.
class MobileAnalyticsBody extends StatelessWidget {
  const MobileAnalyticsBody({
    super.key,
...
class _MobileHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.fromLTRB(showBackButton ? 4 : 16, 8, 16, 4),
      child: Row(
        children: [
          if (showBackButton)
            IconButton(
