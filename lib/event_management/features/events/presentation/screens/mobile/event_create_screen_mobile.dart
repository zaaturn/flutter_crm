...
class _EventCreateScreenMobileState extends State<EventCreateScreenMobile> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<EventBloc, EventState>(
      ...
      child: Scaffold(
        backgroundColor: _ZaaturnCreateUI.bg,
        body: SafeArea(
          bottom: false,
          child: Column(
            children: [
                            ...
                            children: [
                              Text(
                                ...
                                style: GoogleFonts.manrope(
                                  ...
                                  color: _ZaaturnCreateUI.textMuted,
                                ),
                              ),
                              ...
                              TextFormField(
                                ...
                                style: GoogleFonts.manrope(
                                  ...
                                  color: _ZaaturnCreateUI.textDark,
                                ),
                                decoration: InputDecoration(
                                  hintText: 'Untitled Event',
                                  hintStyle: GoogleFonts.manrope(
                                    fontWeight: FontWeight.w800,
                                    color: _ZaaturnCreateUI.textMuted.withValues(alpha: 0.8),
                                  ),
                                  filled: true,
                              ...
                              _pillRow(
                                ...
                                child: Switch.adaptive(
                                  value: _isAllDay,
                                  activeColor: _ZaaturnCreateUI.terracotta,
                            ...
                            children: [
                              ...
                              FilledButton(
                                style: FilledButton.styleFrom(
                                  backgroundColor: _ZaaturnCreateUI.terracotta,
                                  ...
                                  children: _participants
                                      .map(
                                        (p) => Chip(
                                          ...
                                          shape: RoundedRectangleBorder(
                                            side: BorderSide(
                                              color: _ZaaturnCreateUI.terracotta.withValues(alpha: 0.25),
                                            ),
      ...
      builder: (context, child) => Theme(
        data: Theme.of(context).copyWith(
          colorScheme: Theme.of(context).colorScheme.copyWith(
                primary: _ZaaturnCreateUI.terracotta,
                onPrimary: Colors.white,
                surface: _ZaaturnCreateUI.bg,
                onSurface: _ZaaturnCreateUI.textDark,
              ),
        ),
        child: child!,
      ),
        ...
        children: [
          IconButton(
            ...
            icon: const Icon(Icons.arrow_back_ios_new_rounded,
                color: _ZaaturnCreateUI.textDark, size: 20),
          ),
          Text(
            title,
            style: GoogleFonts.manrope(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _ZaaturnCreateUI.card,
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: _ZaaturnCreateUI.terracotta.withValues(alpha: 0.12),
        ),
      ),
      child: child,
    );
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, color: _ZaaturnCreateUI.terracotta, size: 20),
        ),
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.edit_calendar_rounded,
                color: _ZaaturnCreateUI.terracotta.withValues(alpha: 0.9)),
          ],
        ),
      ),
    );
...
class _ReminderChipState extends State<_ReminderChip> {
  @override
  Widget build(BuildContext context) {
    final state = context.findAncestorStateOfType<_EventCreateScreenMobileState>();
    ...
    return FilterChip(
      ...
      labelStyle: GoogleFonts.manrope(
        fontWeight: FontWeight.w800,
        color: selected ? Colors.white : _ZaaturnCreateUI.textDark,
      ),
      backgroundColor: Colors.white.withValues(alpha: 0.55),
      selectedColor: _ZaaturnCreateUI.terracotta,
      onSelected: (v) {
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(999),
        side: BorderSide(
          color: _ZaaturnCreateUI.terracotta.withValues(alpha: 0.15),
        ),
      ),
    );
  }
